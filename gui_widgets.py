...
def section_label (parent ,text :str )->tk .Frame :
    ...
    frame =tk .Frame (parent ,bg =theme.PANEL_BG )
    tk .Frame (frame ,bg =theme.RED_ACCENT ,width =3 ).pack (side ="left",fill ="y",padx =(0 ,8 ))
    tk .Label (frame ,text =text .upper (),bg =theme.PANEL_BG ,
    fg =theme.NAVY_DARK ,font =theme.FONT_TITLE ).pack (side ="left",anchor ="w")
    return frame 
...
=======
    ...
    bg =theme.NAVY_DARK ,fg =theme.WHITE ,hover_bg =None ,
...
class FilePickerRow (tk .Frame ):
    ...
    **kwargs ,
        ...
        lbl =tk .Label (
        self ,text =label ,bg =theme.PANEL_BG ,fg =theme.TEXT_FG ,
        font =theme.FONT_BOLD ,width =22 ,anchor ="w",
        )
        lbl .grid (row =0 ,column =0 ,padx =(0 ,8 ),sticky ="w")

        entry =tk .Entry (
        self ,textvariable =self ._path ,font =theme.FONT_MAIN ,
        width =48 ,relief ="flat",bg ="#ffffff",
        fg =theme.TEXT_FG ,insertbackground =theme.NAVY ,
        ...
        self ,text ="Browse",
        command =lambda :self ._browse (filetypes ),
        **theme.BTN_MUTED_STYLE ,font =theme.FONT_BOLD ,padx =12 ,pady =5 ,radius =6 ,
        ).grid (row =0 ,column =2 )

        if tooltip :
            tip =tk .Label (
            self ,text =tooltip ,bg =theme.PANEL_BG ,fg =theme.TEXT_MUTED ,
            font =theme.FONT_SUB ,
            )
            tip .grid (row =1 ,column =1 ,sticky ="w",pady =(2 ,0 ))
